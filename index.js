...
function getLADataFromAPI(){
    ...
    .then(function(json){
        ...
        var newData = json.filter(function(item){
          return item.total_population === "> 1000"
        })
                ...
                <div class="col s6 m4">
                  <div class="card">
                    <div class="card-image">
                      ...
                      <span class="card-title">${item.zip_code}</span>
                    </div>
                    <div class="card-content">
                      <p>
                        Population based on area zip code ${item.zip_code} the total population is ${item.total_population}.
                      </p>
                    </div>
                  </div>
                </div>
